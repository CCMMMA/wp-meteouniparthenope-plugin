                        ...
                        <?php if (get_post_type() === 'instruments') : ?>
                            <!-- Template per Place con preview meteo -->
                                ...
                                <div class="instruments-info">
                                    ...
                                    <p class="instruments-description"><?php the_excerpt(); ?></p>
                                    <?php
                                        $instrumentID = get_post_meta(get_the_id(), 'instrument_id', true);
                                        echo do_shortcode('[instruments_live_preview_shortcode instrument_id="'.$instrumentID.'"]');
                                        $i++;
                                    ?>
                                </div>
